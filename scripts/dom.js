...
export const hemdPalettePanel = document.getElementById("hemdPalettePanel");
export const hemdPaletteCanvas = document.getElementById("hemdPaletteCanvas");
...
export const bboxInfoText = document.getElementById("bboxInfo");
